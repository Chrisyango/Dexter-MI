				...
				<div class="row">
							...
							<div class="news-link-wrapper">
								<a href="./" class="news-link">
									<div class="news-link-info">
										...
										<p>
											As part of the Grandview Commons condominium project, a Rectangular Rapid Flashing Beacon (RRFB) has been installed at the intersection of Baker and Grand. The RRFB can be activated by... 
										</p>
								...
								<a href="./" class="news-link">
									<div class="news-link-info">
										...
										<p>
											The last day for loose leaf collection via vacuum truck is Friday, December 14, 2018. If you have a pile to be collected, please send an e-mail to cnicholls@dextermi.gov for more information... 
										</p>
								...
								<a href="./" class="news-link">
									<div class="news-link-info">
										...
										<p>
											The ice rink in Monument Park has been installed. Opening day will be announced on the website, e-mail update and Facebook page...
										</p>
										<span>december 13, 2018</span>
										<a href="./">read more</a>
									</div><!-- /.news-link-info -->
					...
					<section id="quick-links" class="col-md-3">
						...
						<ul>
							...
							<li><a href="./">Residential Handbook</a></li>
